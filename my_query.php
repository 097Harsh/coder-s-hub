...
$result = $obj->query("select * from query where user_id='$id'");
...
$result2 = $obj->querY("select answer.a_id,answer.q_id,answer.answer,user.name from answer inner join user on  answer.user_id = user.user_id");
