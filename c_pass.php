...
if(isset($_POST['submit']))
{
    ...
    $exe = $obj->query("update company set password='$pass' where com_id='$user_id'");
...
<section class="w3l-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-5 pt-lg-5 pt-sm-3">you forgote password</h2>
    ...
    <div class="contacts-12 py-lg-12 py-md-12">
        <div class="col-lg-12 ">
            ...
            <div class="map-content-9">
                    <h5 class="mb-sm-4 mb-3">Update your password</h5>
                    <form  method="post">
                        <div class="twice">
