...
if(isset($_POST['submit'])){
  ...
  $exe = $obj->query("insert into query(subject,description,que,date,user_id) values
  ('$sub','$desc','$que','$date','$user_id')");
     
  if($exe)
  {
    echo "<script>alert('Query sended succesfully'); </script>";
  }
  else
  {
...
<section class="w3l-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-5 pt-lg-5 pt-sm-3">ask questions</h2>
            <ul class="breadcrumbs-custom-path pb-sm-5 pb-4 mt-2 text-center mb-md-5">
                <li><a href="index.html">Home</a></li>
                <li class="active"> / Ask for questions </li>
            </ul>
        </div>
    </div>
    ...
    <div class="contacts-12 py-lg-12 py-md-12">
        <div class="col-lg-12 ">
            ...
            <div class="map-content-9">
                    <h5 class="mb-sm-4 mb-3">Query</h5>
                    <form  method="post">
                        <div class="twice">
                        ...
                        <div class="twice">                               
                                   <input type="text" class="form-control" name="que" id="que" placeholder="Question"
                                required="" >
                        </div>
