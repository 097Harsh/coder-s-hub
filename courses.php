...
$result = $obj->query("SELECT q_id,subject,description,que FROM query");
...
<section class="w3l-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-5 pt-lg-5 pt-sm-3">Share your knowledge </h2>
            <ul class="breadcrumbs-custom-path pb-sm-5 pb-4 mt-2 text-center mb-md-5">
                <li><a href="index.html">Home</a></li>
                <li class="active"> / get answer </li>
            </ul>
        </div>
    </div>
...
<table class="table">
  ...
  <?php 
    ...
    <tr>
      ...
      <td><a href="answer.php?moreid=<?php echo $row->q_id; ?>">Answer</a></td>
      <td></td>
    </tr>
  </tbody>
  <?php } ?>
