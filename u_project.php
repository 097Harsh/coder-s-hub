...
if(isset($_POST['submit'])){
  ...
  $tmp1 = $_FILES['s']['tmp_name'];
  $path1 = "upload1/$filename1";
  ...
  $exe = $obj->query("insert into project(title,description,technology,user_id,date,s_code) 
  values('$sub','$desc','$que','$user_id','$date','$filename1')");
...
<section class="w3l-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-5 pt-lg-5 pt-sm-3">Upload project</h2>
    ...
    <div class="contacts-12 py-lg-12 py-md-12">
        <div class="col-lg-12 ">
            ...
            <div class="map-content-9">
                    <h5 class="mb-sm-4 mb-3">Upload project</h5>
                    <form  method="post" enctype="multipart/form-data">
                        ...
                        <div class="twice">                               
                                   <input type="text" class="form-control" name="tech" id="tech" placeholder="Technology"
                                required="" >
                        </div>
                       
                        <div class="twice">  
                                                       
                                <input type="file" class="form-control" name="s" id="s" placeholder=" "
                                required="">
                        </div>
